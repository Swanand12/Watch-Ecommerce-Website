...
const VerifyOtp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${backend_url}/api/v1/auth/verify-otp`, {
        email,
        otp,
      });
      if (res.data.success) {
          ...
          >
            <div className="mb-8 flex flex-col">
              ...
              <span className="text-black ">
                Verify OTP to set new password
              </span>
            </div>

            <div className="mb-10 relative ">
              <IoKeyOutline className="absolute left-3 text-purple-900 top-2 text-2xl" />
              <input
                value={otp}
            ...
            <p className="">
              ...
              <span className="text-purple-900">
                <Link to={"/request-otp"}> requestOtp </Link>
              </span>
              page
            </p>
          </form>
